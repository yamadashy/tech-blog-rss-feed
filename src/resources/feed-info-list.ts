...
/**
 * フィード情報一覧。ラベルのソート順（`npm run sort-feed-info-list` で並べ替え）
...
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  ...
  ['ADAWARP', 'https://zenn.dev/p/adawarp/feed'],
  ['Adways', 'https://blog.engineer.adways.net/feed'],
  ['AEON', 'https://zenn.dev/p/aeonpeople/feed'],
  ...
  ['ALGO ARTIS', 'https://zenn.dev/p/algoartis/feed'],
  ...
  ['BALEEN STUDIO', 'https://zenn.dev/p/baleenstudio/feed'],
  ...
  ['Bitkey', 'https://zenn.dev/p/bitkey_dev/feed'],
  ...
  ['e-Agency', 'https://zenn.dev/p/e_agency/feed'],
  ['ecbeing', 'https://blog.ecbeing.tech/feed'],
  ['efoo', 'https://efoo.hatenablog.com/feed'],
  ['ELEMENTS', 'https://zenn.dev/p/elements/feed'],
  ...
  ['Fixstars Amplify', 'https://zenn.dev/p/amplify/feed'],
  ...
  ['GA technologies', 'https://zenn.dev/p/gatechnologies/feed'],
  ...
  ['Geekplus', 'https://zenn.dev/p/geekplus/feed'],
  ['Gemcook', 'https://zenn.dev/p/gemcook/feed'],
  ['GENDA', 'https://zenn.dev/p/genda_jp/feed'],
  ['Generative Agents', 'https://blog.generative-agents.co.jp/feed'],
  ['GENIEE', 'https://zenn.dev/p/geniee/feed'],
  ...
  ['GMOメディア', 'https://zenn.dev/p/gmomedia/feed'],
  ...
  ['GVA TECH', 'https://zenn.dev/p/gvatech_blog/feed'],
  ['Hacobu', 'https://zenn.dev/p/hacobu/feed'],
  ...
  ['hokan', 'https://zenn.dev/p/hokan_blog/feed'],
  ...
  ['INAP Vision', 'https://zenn.dev/p/inapvision/feed'],
  ['Insight Edge', 'https://techblog.insightedge.jp/feed'],
  ['INTAGE', 'https://zenn.dev/p/intage_tech/feed'],
  ...
  ['jinjer', 'https://zenn.dev/p/jinjer_techblog/feed'],
  ['JINS', 'https://zenn.dev/p/jins/feed'],
  ['JMDC', 'https://techblog.jmdc.co.jp/feed'],
  ['JOPS', 'https://zenn.dev/p/jops/feed'],
  ...
  ["Linc'well", 'https://zenn.dev/p/lincwell_inc/feed'],
  ...
  ['mediba', 'https://zenn.dev/p/mediba/feed'],
  ...
  ['Nexta', 'https://zenn.dev/p/nexta_/feed'],
  ...
  ['Omiai', 'https://zenn.dev/p/omiai_techblog/feed'],
  ...
  ['PKSHA', 'https://zenn.dev/p/pksha/feed'],
  ...
  ['RemitAid', 'https://zenn.dev/p/remitaid/feed'],
  ...
  ['satto', 'https://zenn.dev/p/satto_workspace/feed'],
  ['SB Intuitions', 'https://www.sbintuitions.co.jp/blog/feed'],
  ['SB OAI Japan', 'https://zenn.dev/p/sboai_tech/feed'],
  ['Scalar', 'https://zenn.dev/p/scalar_sol_blog/feed'],
  ['SCOグループ', 'https://zenn.dev/p/scogr_tech/feed'],
  ['SCSK', 'https://blog.usize-tech.com/feed/'],
  ['SecureNavi', 'https://zenn.dev/p/securenavi_tech/feed'],
  ...
  ['Skyfall', 'https://zenn.dev/p/skyfall/feed'],
  ...
  ['Spectee', 'https://zenn.dev/p/spectee/feed'],
  ...
  ['Sun*', 'https://zenn.dev/p/sun_asterisk/feed'],
  ...
  ['TOKIUM', 'https://zenn.dev/p/tokium_dev/feed'],
  ...
  ['truestar', 'https://zenn.dev/p/truestar/feed'],
  ...
  ['Virtual Craft', 'https://zenn.dev/p/virtualcraft/feed'],
  ...
  ['Weathernews', 'https://zenn.dev/p/weathernews/feed'],
  ['WESEEK', 'https://weseek.co.jp/tech/feed/'],
  ['WOGO', 'https://zenn.dev/p/wogo_techblog/feed'],
  ...
  ['アクトビ', 'https://zenn.dev/p/actbe_tech/feed'],
  ...
  ['アンドドット', 'https://zenn.dev/p/and_dot/feed'],
  ['イエソド', 'https://zenn.dev/yesodco/feed'],
  ['イタンジ', 'https://tech.itandi.co.jp/feed'],
  ['イノベーション', 'https://zenn.dev/p/innovation/feed'],
  ...
  ['インフォメーション・ディベロプメント', 'https://zenn.dev/p/idnet/feed'],
  ...
  ['エスマット', 'https://zenn.dev/p/smartshopping/feed'],
  ...
  ['エムニ', 'https://zenn.dev/p/emuni/feed'],
  ...
  ['サイバーセキュリティクラウド', 'https://zenn.dev/p/cscloud_blog/feed'],
  ['サイバーディフェンス研究所', 'https://io.cyberdefense.jp/index.xml'],
  ['サイバネットITソリューション', 'https://zenn.dev/p/cybernet_itsol/feed'],
  ...
  ['ソニックムーブ', 'https://zenn.dev/p/sonicmoov/feed'],
  ['ソフトバンク', 'https://zenn.dev/p/softbank/feed'],
  ...
  ['フォトラクション', 'https://zenn.dev/p/photoruction_bl/feed'],
  ...
  ['プログデンス', 'https://zenn.dev/p/progdence/feed'],
  ...
  ['ポート', 'https://zenn.dev/p/port_inc/feed'],
  ...
  ['マルチコンピューティング', 'https://zenn.dev/p/mcc_techblog/feed'],
  ...
  ['ミクステンド', 'https://zenn.dev/p/mixtend/feed'],
  ...
  ['メンバーズ AIフォーオールカンパニー', 'https://zenn.dev/p/aiforall/feed'],
  ...
  ['リバネスナレッジ', 'https://zenn.dev/p/lnest_knowledge/feed'],
  ...
  ['レトリバ', 'https://zenn.dev/p/retrieva_tech/feed'],
  ...
  ['楽天カード', 'https://zenn.dev/p/rakutencardtech/feed'],
  ...
  ['三菱UFJインフォメーションテクノロジー', 'https://zenn.dev/p/muit_techblog/feed'],
