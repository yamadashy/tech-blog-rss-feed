...
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  ...
  ['CoeFont', 'https://zenn.dev/p/coefont/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['OPTIMIND', 'https://zenn.dev/p/optimind/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['PharmaX', 'https://zenn.dev/p/pharmax/feed', [FLAG_ZENN_PUBLICATION]],
  ['PLAY', 'https://developers.play.jp/rss'],
  ...
  ['SALESCORE', 'https://zenn.dev/p/salescore/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['Social Databank', 'https://zenn.dev/p/sdb_blog/feed', [FLAG_ZENN_PUBLICATION]],
  ['Speee', 'https://tech.speee.jp/feed'],
  ['Spiral.AI', 'https://zenn.dev/p/spiralai/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['moze', 'https://zenn.dev/p/moze_ai/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['ゲームエイト', 'https://zenn.dev/p/game8_blog/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['コラボスタイル', 'https://zenn.dev/p/collabostyle/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['ニコシス', 'https://zenn.dev/p/nicosys_pub/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['ログラス', 'https://zenn.dev/p/loglass/feed', [FLAG_ZENN_PUBLICATION]],
  ...
  ['損害保険ジャパン DX推進部', 'https://zenn.dev/p/sompojapan_dx/feed', [FLAG_ZENN_PUBLICATION]],
