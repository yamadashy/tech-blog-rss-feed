...
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  ...
  ['MonotaRO', 'https://tech-blog.monotaro.com/feed'],
  ...
  ['ドクターズプライム', 'https://blog.drsprime.com/feed/category/エンジニアリング'],
  ...
  ['楽天コマース', 'https://commerce-engineer.rakuten.careers/feed/category/テック'],
